...
- [Architecture highlights](../../architecture/1.architecture-highlights.md) — how the components fit together at runtime
- [What is DIAL](../../positioning/0.what-is-dial.md) — start here if you are new to the platform
