...
- An [application](./2.glossary.md#application) is also a deployment. Because applications and models both speak the Unified API, an application can call a model — or another application — through the same interface. This interchangeability is the basis of the [agentic platform](../../capabilities/1.agentic-platform.md).
...
- [Architecture highlights](../../architecture/1.architecture-highlights.md) — how these components behave at runtime
- [Agentic platform](../../capabilities/1.agentic-platform.md) — why composition through the Unified API is the core design choice

## Next steps

- [DIAL Stack](../../architecture/2.dial-stack.md) — the concrete services and dependencies behind these concepts
- [DIAL evolution](../3.dial-evolution.md) — how the platform grew into this shape
