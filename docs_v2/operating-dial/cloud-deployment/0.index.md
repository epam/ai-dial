...
- [DIAL Stack](../../understand-dial/architecture/2.dial-stack.md) — the components the charts deploy and how they fit together
- [Core configuration](../configuration/core/0.index.md) — the `config.json` and `settings.json` the charts render
