...
| Adapters and Applications | Traces, metrics (including system CPU and memory), and logs over OTLP | [DIAL SDK telemetry](../../building-with-dial/developer-tools/sdk-reference/5.telemetry.md) (Python) |
...
- [DIAL Stack](../../understand-dial/architecture/2.dial-stack.md) — the components that emit the telemetry described here
- [SDK telemetry reference](../../building-with-dial/developer-tools/sdk-reference/5.telemetry.md) — how applications and adapters built on the DIAL SDK emit OTEL signals
