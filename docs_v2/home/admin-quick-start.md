...
Open the **Entities** section. Entities are the models, applications, routes, and tool sets that DIAL Core exposes through the [Unified API](../understand-dial/architecture/4.unified-api-overview.md).
