...
Open the **Entities** section. Entities are the models, applications, routes, and toolsets that DIAL Core exposes through the [Unified API](../2.understand-dial/2.architecture/4.unified-api-overview.md).
