...
- **Review files** — files available to [administrators](../5.administering-dial/7.publications-and-review.md) while reviewing publication requests.
...
**Note**
> See [Authentication and access control](../2.understand-dial/4.security-and-governance/1.authentication-and-access-control.md) to learn more about private and public spaces in DIAL file storage.
