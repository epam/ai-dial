...
- [MCP server integration](../3.building-with-dial/1.apps/2.quick-apps/1.quick-app-2/9.toolsets/2.mcp-server-integration.md) — tool call failures, toolset auth, OAuth redirects.
