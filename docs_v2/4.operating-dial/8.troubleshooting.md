...
Sustained 5xx or latency from adapters warrants an alert; see [Configure metrics](./6.observability/2.configure-metrics.md) and [Alerting](./6.observability/4.alerting.md).
