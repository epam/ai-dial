...
| Adapters and Applications | Traces, metrics (including system CPU and memory), and logs over OTLP | [DIAL SDK telemetry](../../3.building-with-dial/5.developer-tools/1.sdk-reference/4.telemetry.md) (Python) |
