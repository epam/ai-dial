...
| Adapters and Applications | Yes, including system CPU and memory metrics | Yes | [DIAL SDK telemetry](../../3.building-with-dial/5.developer-tools/1.sdk-reference/5.telemetry.md) (Python) |
