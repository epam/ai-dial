...
The reference file is at [`dial-docker-compose-advanced/dial-2.x/keycloak/import/realm-config.json`](https://github.com/epam/ai-dial/blob/main/dial-docker-compose-advanced/dial-2.x/keycloak/import/realm-config.json).
