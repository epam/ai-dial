...
See [DIAL Chat configuration](../../../4.operating-dial/4.configuration/2.chat-configuration.md) for the full environment variable reference.
...
- [DIAL Chat configuration](../../../4.operating-dial/4.configuration/2.chat-configuration.md) — environment variables and feature flags for Chat
