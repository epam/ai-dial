...
- [Connect the Claude M365 plugin to DIAL](7.claude-m365-plugin.md) — front DIAL with an NGINX reverse proxy so the Claude for Microsoft 365 Office add-ins can use it as a gateway
