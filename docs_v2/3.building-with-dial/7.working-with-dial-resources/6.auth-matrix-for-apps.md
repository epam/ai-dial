...
Dependencies and consent requirements are declared in the DIAL Core [applications configuration](../../4.operating-dial/4.configuration/1.core/2.config-json/2.applications.md).
...
- [Applications configuration](../../4.operating-dial/4.configuration/1.core/2.config-json/2.applications.md) — declare dependencies and consent requirements
