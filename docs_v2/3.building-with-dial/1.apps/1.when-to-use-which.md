...
| **External network access** | Full (your infrastructure) | Via web API Toolsets | None | Source URLs only (at creation time) |
...
- **"I want to compose a workflow from existing models, apps, and external APIs — without writing code."**
    ...
    Use a **Quick App**. Combine a language model with system instructions and Toolsets (web APIs, MCP servers, other DIAL apps) to create a workflow in minutes.
...
- [Custom Apps: architecture and lifecycle](5.custom-apps/0.index.md) — build and deploy a containerized app
- [What are Quick Apps](2.quick-apps/0.index.md) — no-code orchestration with models and tools
- [Code Apps overview](3.code-apps/0.index.md) — write and deploy Python in the browser
- [Mind Map Studio overview](4.mind-map-studio/0.index.md) — knowledge graphs from documents
