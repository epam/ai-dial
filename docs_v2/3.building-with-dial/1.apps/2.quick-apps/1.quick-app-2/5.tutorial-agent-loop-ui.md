...
The Tool Set now appears as a card in **My workspace → Toolsets**. For more details on each authentication option, see [Define and register a Tool Set](./9.tool-sets/1.define-and-register.md).
...
- [Share and manage Tool Set permissions](./9.tool-sets/3.sharing-and-permissions.md) — publish your Tool Set to the Marketplace
