...
- [Share and manage Tool Set permissions](3.sharing-and-permissions.md) — publish to Marketplace
- [Add tools to a Quick App 2.0](../4.working-with-tools-and-agents.md) — reference Tool Sets from an app
