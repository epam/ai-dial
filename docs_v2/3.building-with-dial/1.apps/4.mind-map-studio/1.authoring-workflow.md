...
- Source material ready: one or more web URLs, files (PDF, PPTX, HTML, TXT), or a combination

## Launch Mind Map Studio

1. In [My Workspace](../../../6.chat-user-guide/0.index.md), click **Add app** and select **Mind Map**.
...
- [When to use which app type](../1.when-to-use-which.md) — compare Mind Map Studio with other DIAL app types
