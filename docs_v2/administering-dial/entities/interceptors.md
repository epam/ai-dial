...
In this tab, you can see Application Runners that a specific interceptor is currently associated with. Application Runners are used to run [schema-rich applications](../../building-with-dial/apps/0.index.md#schema-based-apps) of specific types. By creating this binding, you can determine what types of applications will use the selected interceptor during their execution.
