...
If you encounter a synonym or variant not listed below, use the canonical term instead. See the [concept map](./1.concept-map.md) for a visual overview of how these terms relate.
...
- [Concept map](./1.concept-map.md) — see how these terms relate to one another
- [Architecture highlights](../../2.architecture/1.architecture-highlights.md) — how the components fit together at runtime
- [What is DIAL](../../1.positioning/1.what-is-dial.md) — start here if you are new to the platform
