...
In DIAL Marketplace you find all Tool Sets available in your environment. You can access only those allowed for your [user role](../understand-dial/security-and-governance/1.authentication-and-access-control.md). In [your workspace](./3.marketplace-and-apps.md), you access Tool Sets added from the Marketplace and add new ones.
...
**Note**
> Administrators can manage authentication for public Tool Sets, including logging in and out with organization credentials on behalf of all users. See [Publications and review](../administering-dial/6.publications-and-review.md).
...
- [Tool Sets for developers](../building-with-dial/apps/quick-apps/quick-app-2/tool-sets/0.index.md) — define, register, and integrate MCP servers
