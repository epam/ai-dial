---
# Generated by scripts/build-changelog.ts from docs/releases/1.43/upgrade-to-1.43.md — do not hand-edit.
title: "Upgrade to DIAL 1.43"
sidebar_label: "1.43 upgrade guide"
sidebar_position: -2085
type: "reference"
persona: "devops"
component: "helm"
description: "Helm chart and component versions, configuration changes, and deprecations for DIAL 1.43."
---
## Versions
...
|----------------------------------|---------|---------|-------------|
| QWEN3_ASR_VLLM_DEPLOYMENTS       | ``      | No| Comma-separated list of Qwen3-ASR deployments served via vLLM. Example: `qwen3-asr` |
