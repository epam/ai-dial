---
# Generated by scripts/build-changelog.ts from docs/releases/1.43/1.43-release-notes.md — do not hand-edit.
title: "DIAL 1.43 release notes"
sidebar_label: "1.43 release notes"
sidebar_position: -2086
type: "reference"
persona: "all"
component: "platform"
description: "The highlights of this release include a new Evaluation Framework for AI quality assessment, expanded MCP ecosystem support with registry integration and application-level MCP endpoints, significant Quick Apps editor improvements, and expanded…"
---
