---
# Generated by scripts/build-changelog.ts from docs\releases\1.46\1.46-release-notes.md — do not hand-edit.
title: "DIAL 1.46 release notes"
sidebar_label: "1.46 release notes"
sidebar_position: -2092
type: "reference"
persona: "all"
component: "platform"
description: "The highlights of this release on the DIAL core side include native support of agent skills, redesigned and unified configuration of application endpoints, and major improvements to OAuth Recovery capabiltiies for MCP Toolset connectivity. The…"
---
