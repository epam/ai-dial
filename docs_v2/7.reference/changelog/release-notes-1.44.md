---
# Generated by scripts/build-changelog.ts from docs/releases/1.44/1.44-release-notes.md — do not hand-edit.
title: "DIAL 1.44 release notes"
sidebar_label: "1.44 release notes"
sidebar_position: -2088
type: "reference"
persona: "all"
component: "platform"
description: "The highlights of this release include a refreshed DIAL brand identity with new logos and a website re-design, major Quick Apps enhancements including Skills support, pre-configured tool orchestration, and MCP connectivity for connected…"
---
