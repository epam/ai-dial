---
# Generated by scripts/build-changelog.ts from docs\releases\1.45\1.45-release-notes.md — do not hand-edit.
title: "DIAL 1.45 release notes"
sidebar_label: "1.45 release notes"
sidebar_position: -2090
type: "reference"
persona: "all"
component: "platform"
description: "The highlights of this release include significant improvements to Evaluation in the Admin Panel including run comparisons and reusable datasets, additional connecting protocols for applications, support for long-running sessions via Responses API,…"
---
...
![](img/evaluation-comparison-2.png)
