...
1. **Navigation rail** — switch between the three main sections of DIAL Chat: **Chats**, **Catalog**, and **File Manager**.
...
6. **Catalog** — browse all models, agents, toolsets, skills, and prompts available in your DIAL environment, and create new ones. See [Catalog](./2.catalog/0.index.md).
7. **File Manager** — manage your files. See [File Manager](./3.files.md).
...
![The navigation rail with icons for Chats, Catalog, and File Manager](img/nav-rail.png)
...
- [Catalog](./2.catalog/0.index.md) — find agents and models, and add them to your favorites
- [Usage and settings](./5.usage-and-settings.md) — track usage, set keyboard shortcuts, and configure conversation defaults
