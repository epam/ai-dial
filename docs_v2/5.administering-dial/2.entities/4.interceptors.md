...
You can configure global interceptors that apply on a system level in [System Properties](../1.config-backup-and-global-settings.md#system-properties) and local interceptors that are triggered for specific [model](./1.models.md#interceptors) or [application](./2.applications.md#interceptors) deployments, or apps created based on [application runners](../3.builders.md).
...
| **Source Type** | Source type of the interceptor:<br />- [Interceptor Template](../3.builders.md): Interceptor is based on a template.<br />- [Interceptor deployment](../5.deployments/2.container-management.md): Interceptor is based on a deployed interceptor image.<br />- External Endpoint: Interceptor is based on an external HTTP endpoint. |
...
2. Define interceptor parameters:
    ...
    | **Source Type** | Yes | Source type of the interceptor:<br />- [Interceptor Template](../3.builders.md): Interceptor is based on a template.<br />- [Interceptor deployment](../5.deployments/2.container-management.md): Interceptor is based on a deployed interceptor image.<br />- External Endpoint: Interceptor is based on an external HTTP endpoint. |
    | **Interceptor template** | Conditional | Interceptor's Template ID. Applies for the Interceptor Template source type. |
    | **Container** | Conditional | Interceptor's [Container ID](../5.deployments/2.container-management.md). Applies for the Interceptor Container source type. |
...
| **Source Type** | Yes | Yes | Source type of the interceptor:<br />- [Interceptor Template](../3.builders.md): Interceptor is based on a template.<br />- [Interceptor deployment](../5.deployments/2.container-management.md): Interceptor is based on a deployed interceptor image.<br />- External Endpoint: Interceptor is based on an external HTTP endpoint. |
...
**Tip**
> You can also define this mapping on the [Models](./1.models.md#interceptors) and [Applications](./2.applications.md#interceptors) configuration screens in the Interceptors tab.
...
In this tab, you can see Application Runners that a specific interceptor is currently associated with. Application Runners are used to run [schema-rich applications](../../3.building-with-dial/1.apps/0.index.md#schema-based-apps) of specific types. By creating this binding, you can determine what types of applications will use the selected interceptor during their execution.
...
**Note**
> This section mimics the functionality available in the global [Activity](../8.audit/1.activity-and-rollback.md) section, but is scoped specifically to the selected interceptor.
...
- [Manage AI model deployments](./1.models.md) — attach interceptors to individual AI model deployments.
- [Manage applications](./2.applications.md) — attach interceptors to application deployments or application runners.
