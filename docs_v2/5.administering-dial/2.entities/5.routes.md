...
**Note**
> - You can also define routes for specific application deployments and Application Runners. Refer to [Applications](./2.applications.md#app-routes) and [Application Runners](../3.builders.md) to learn how to do this.
...
| **Actions** | Additional role-specific actions:<br />- Open the [Roles](../6.access-management/1.roles.md) section in a new tab.<br />- Remove the given role. |
...
**Note**
> This section mimics the functionality available in the global [Activity](../8.audit/1.activity-and-rollback.md) section, but is scoped specifically to the selected route.
...
- [Manage roles and access control](../6.access-management/1.roles.md) — control which roles can invoke each route.
