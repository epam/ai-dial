...
The Entities Consumption table monitors consumption metrics for deployments: models, applications, toolsets, interceptors, and routes. Use it to compare token usage across entities, identify cost-inefficient deployments, and optimize resources.
...
- [Review activity and roll back changes](./1.activity-and-rollback.md) — audit configuration changes and restore previous states
