...
- [Entities](2.entities/1.models.md) — register and configure the models, applications, toolsets,
...
- [Assets](4.assets.md) — organize and govern public resources such as applications, toolsets,
  prompts, and files.
...
- [Publications and review](7.publications-and-review.md) — review and act on the publication requests
  users submit for applications, files, toolsets, and prompts.
