...
**Note**
> Refer to the [Toolsets section below](#toolsets) for details on the **Use all tools**, **Manage tools**, and **Try tools** workflows—the functionality is identical.
...
3. Click **Create**. The dialog closes and the new [toolset configuration screen](#configure-a-toolset) opens. The entry appears immediately in the listing.
   ...
   ![Create Toolset modal](img/create-asset-toolset.png)
...
![Duplicate Toolset dialog](img/duplicate-asset-toolset.png)
...
![Bulk export of toolsets](img/export-toolsets-bulk.png)
...
![Import toolsets dialog](img/import-toolsets.png)
...
![Delete toolset confirmation](img/assets-delete-toolset.png)
...
![Toolset Properties tab](img/134.png)
...
![Toolset authentication configuration](img/assets_toolsets_auth.png)
...
**Tip**
> This section mirrors the global [Dashboard](8.audit/2.monitoring-dashboards.md), scoped to the selected toolset.

![Toolset Audit tab](img/assets-toolsets-audit.png)
...
![Toolset JSON Editor](img/assets_toolsets_json.png)
