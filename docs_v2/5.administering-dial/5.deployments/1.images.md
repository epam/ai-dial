...
| **Save / Save as new version / Save as new image** | The available action depends on what changed:<br />- **Save**: For installed images, applies when only Description, Maintainer, or Topics changed.<br />- **Save as new image**: Applies when the Name changed. The dialog title is **Save new image**.<br />- **Save as new version**: Applies when the Name is unchanged but a new version is wanted. The dialog title is **Save as new version**.<br />![Save button variants](../img/image-save-buttons.png) |
...
- [Manage MCP containers](./3.mcp-containers.md) — deploy MCP server containers and create toolsets from them
