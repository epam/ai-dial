...
2. Fill in the dialog:
   ...
   - **Display Name**: Name shown in the UI. Auto-populated from the container.
   - **Description**: Brief description.
3. Click **Create**. The interceptor appears in [Entities/Interceptors](../2.entities/4.interceptors.md) and can be used by DIAL applications, toolsets, and models, or set as a [global interceptor](../1.config-backup-and-global-settings.md). Repeat to create additional interceptors.
...
- [Manage MCP containers](./3.mcp-containers.md) — deploy MCP server containers and create toolsets
