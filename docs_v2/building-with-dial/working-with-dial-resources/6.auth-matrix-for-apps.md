...
Dependencies and consent requirements are declared in the DIAL Core [applications configuration](../../operating-dial/configuration/core/config-json/2.applications.md).
...
- [Applications configuration](../../operating-dial/configuration/core/config-json/2.applications.md) — declare dependencies and consent requirements
