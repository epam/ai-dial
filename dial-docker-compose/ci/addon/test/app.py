...
async def test_model(deployment_id: str, model: str):
    message = (
        'My name is Anton. Add "buy milk", "buy eggs", "make omelette" to my TODO list.'
    )
    expected_response = "Successfully added 'buy milk', 'buy eggs', and 'make omelette' to your TODO list."
...
async def tests():
    await test_model("todo-assistant", "gpt-4")
    await test_model("todo-assistant", "gpt-35-turbo")
