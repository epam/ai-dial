...
| ~~B2.10~~ | ~~dial-evolution: DIAL roadmap **is** public — https://dialx.ai/roadmap (YuriyIvon — :46)~~ | Yes | Trivial | ✅ **Done in `9676ba30`** — link added, claim removed. |
...
| B6.6 | **Marketplace & apps** | Title "apps" too informal (3.marketplace-and-apps:2); create a dedicated **Toolsets in Marketplace/My workspace** section (referenced by many tool-sets.md links); ~~"Sources" (missing s) (:41)~~ ✅ **done in `9676ba30`**; document new features **Process files** (:199) and **File tools** (:211); delete-when-not-published wording confusing — deletable anytime (:411) | Medium | Creating the Toolsets-in-Marketplace section unblocks several B6.1 links. |
