...
Use the default AI DIAL Core [Configuration](https://github.com/epam/gflog/blob/main/gflog-core/src/main/resources/gflog.xsd) as reference. Refer to [GFLog](https://github.com/epam/gflog/blob/main/README.md) to learn more about the logging framework used in DIAL Core.
