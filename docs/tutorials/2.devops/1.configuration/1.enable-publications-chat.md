...
Refer to [user guide](/docs/tutorials/0.user-guide.md#publication-flow) to learn how chat users can use publications for conversations, prompts and applications.
