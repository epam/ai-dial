...
| **Forward auth token** | This parameter allows to determine whether to forward an Auth Token to your models's endpoint. If enabled, HTTP header with authorization token are forwarded to chat completion endpoint. |
