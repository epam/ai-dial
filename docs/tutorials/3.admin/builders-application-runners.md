...
| **Source type** | Yes | Yes | Provide endpoints DIAL Core will POST orchestration payloads to for any application bound to this runner. <br /> **Chat Endpoint**:<br /> -Chat completion endpoint: URL where your app sends user messages to receive AI-generated responses (e.g. `https://my-runner.example.com/v1/execute`).<br /> -Responses endpoint: URL where your app will receive AI-generated replies and related metadata.<br />**MCP Endpoint**: MCP endpoint of the application runner. Transport is HTTP by default. |
