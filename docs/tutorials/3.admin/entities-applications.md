...
2. Define application's parameters
    ...
    | **Completion endpoint** | Yes | Endpoint URL that will be used to process chat completion requests. <br /> Available if Source Type is **Endpoints** or **Application Container**. |
