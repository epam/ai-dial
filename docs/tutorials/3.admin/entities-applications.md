...
| **Source Type**          | Yes         | Field lets the user choose between “Endpoint” and “Application runner” options.                                                                                                                                                                                                                                     |
| **Application Runner**   | Conditional | Field is shown and required only if Source Type is "Application runner". Allows to select existing [Application type schema](/docs/platform/3.core/7.apps.md#schema-rich-applications) as the basis for the application. Defined in [Application Runners](/docs/tutorials/3.admin/builders-application-runners.md). |
| **Completion endpoint**  | Conditional | Field is shown and required only if Source Type is "Endpoint". The full URL where this Application’s API will be exposed once created.                                                                                                                                                                              |
...
| **Source Type**         | Yes          | Field lets the user choose between “Endpoint” and “Application runner” options.                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| **Application Runner**  | Conditional  | Field is shown and required only if Source Type is "Application runner". Allows to select existing [Application type schema](/docs/platform/3.core/7.apps.md#schema-rich-applications) as the basis for the application. Defined in [Application Runners](/docs/tutorials/3.admin/builders-application-runners.md).                                                                                                                                                                                                  |
| **Completion Endpoint** | Conditional  | Field is editable and required only if Source Type is "Endpoint". Read-only if Source Type is "Application runner" otherwise. The full URL where this Application’s API will be exposed once created.                                                                                                                                                                                                                                                                                                                |
| **Viewer URL**          | Conditional  | Only shown if Source Type is "Endpoint". An optional field that contains the URL of the application's custom UI for viewing purposes.                                                                                                                                                                                                                                                                                                                                                                                |
| **Editor URL**          | Conditional  | Only shown if Source Type is "Endpoint". An optional field that contains the URL of the application's custom builder UI for editing purposes.                                                                                                                                                                                                                                                                                                                                                                        |
