...
DIAL includes standard application types such as Quick app, Code app and Mind Map. To cover specific scenarios, you can add new application types, featuring custom application UI (`applicationTypeViewerUrl`) and wizards (`applicationTypeEditorUrl`) and enabling end-users to create applications of that type.
...
DIAL includes standard application types with wizards for Quick apps, Code apps and Mind Maps. DIAL gives you an opportunity to create custom application types with custom or auto-generated wizards.
...
DIAL includes a UI wizard to add a custom application which has a chat completion endpoint.
