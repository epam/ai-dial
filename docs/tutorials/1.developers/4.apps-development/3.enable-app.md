...
DIAL can serve as a universal platform that allows using both [DIAL-native applications](#dial-native-applications) and [applications developed on other platforms](#enable-not-dial-native-apps).
