...
> Refer to [User guide](/docs/tutorials/0.user-guide.md#custom-apps) to learn how to create a custom app.
...
If you enable your application by directly modifying the [DIAL Core configuration](https://github.com/epam/ai-dial-core?tab=readme-ov-file#dynamic-settings), you can add [user roles](https://github.com/epam/ai-dial-core/blob/development/docs/dynamic-settings/applications.md) to the JSON object with the configuration of the application. This allows you to define access permissions for other users as well as impose usage limits.

> * Refer to [Access Control](/docs/platform/3.core/2.access-control-intro.md) to learn about role-based access to applications in DIAL.
> * Refer to [Tutorials](/docs/tutorials/2.devops/2.auth-and-access-control/0.api-keys.md) to learn how to define role-based access to DIAL resources for API keys.

If you enable your application by directly modifying the [DIAL Core configuration](https://github.com/epam/ai-dial-core?tab=readme-ov-file#dynamic-settings), you can add [user roles](https://docs.dialx.ai/platform/core/access-control-intro#roles-as-subjects) to the JSON object with the configuration of the application. This allows you to define access permissions for other users as well as impose usage limits.
