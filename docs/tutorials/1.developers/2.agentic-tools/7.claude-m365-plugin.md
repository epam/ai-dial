...
- [Connect Claude Cowork to DIAL](/docs/tutorials/1.developers/2.agentic-tools/6.claude-cowork.md) — route Anthropic's desktop agent through DIAL with third-party inference
