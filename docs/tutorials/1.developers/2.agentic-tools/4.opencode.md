...
- [Connect Claude Code to DIAL](/docs/tutorials/1.developers/2.agentic-tools/5.claude-code.md) — a command-line agent that uses the native Anthropic Messages API
