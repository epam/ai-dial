...
- [Connect the Claude M365 plugin to DIAL](/docs/tutorials/1.developers/2.agentic-tools/7.claude-m365-plugin.md) — front DIAL with an NGINX reverse proxy so the Claude for Microsoft 365 Office add-ins can use it as a gateway
...
- [Connect Codex to DIAL](/docs/tutorials/1.developers/2.agentic-tools/1.codex.md) — start with the most involved case, which shows both the direct and proxy paths
