...
> Watch a [Video Demo](/docs/video%20demos/3.Developers/Integrations/15.dial-n8n-integration.md) to see how to build an AI-powered HR assistant that automatically responds to employee emails using custom DIAL agents and n8n automation.
