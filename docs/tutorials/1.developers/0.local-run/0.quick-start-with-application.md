...
> Refer to [Architecture](/docs/platform/0.architecture-and-concepts/2.architecture.md) to learn more about available DIAL setups and [system components](/docs/platform/0.architecture-and-concepts/2.architecture.md).
