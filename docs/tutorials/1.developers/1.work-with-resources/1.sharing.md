...
The exception is made for [interceptors](/docs/platform/3.core/6.interceptors.md). If a deployment grants permissions to its interceptor, then this interceptor will have the same permissions as well. 
