...
1. Click any model.
2. Click **Use model** to start a new conversation with it.
...
In your workspace, you can access applications that you added on Marketplace and also add your own.
...
2. Click **Use application** to start a new conversation with it.
