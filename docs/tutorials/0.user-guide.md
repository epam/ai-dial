...
If you want to remove access to a prompt that you have shared, click **Share** and click **Remove access for all users**.

### Unshare

To remove a shared with prompt from the list, click  **Unshare** in the contextual menu and then confirm actions in the dialog window.
...
Enter `/` in the chat text box to select one of the available prompts. You can also click [Use](#use) in the prompt's menu to populate it in the text box or invoke a pop-up window where you can populate prompt variables.
...
If the selected application supports this, you can click the attachment icon in the conversation box and select **Attach uploaded files** or **Upload from device**.
...
You can also unshare folders with source files of the share with you applications.
