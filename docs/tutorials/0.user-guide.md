...
2. Select a conversation and click **Unpublish** in the [actions menu](#actions).
...
2. Select a prompt and click **Unpublish** in the [actions menu](#actions-1).
...
2. Select **Unpublish** in the actions menu of the selected application.
...
In DIAL Marketplace you can find all [applications](#applications), toolsets, agents and [language models](#available-models) available on your DIAL environment. Each user can access only those resources that are available to their user role.
...
Click **DIAL Marketplace** to navigate to the *home page* of DIAL Marketplace. Here, you can find all [applications](#applications), agents, toolsets and [language models](#available-models) available on your DIAL environment for your user role, including all applications [published](#publish-app) in your organization and [shared](#share-app) with you by other users.
...
2. In the applications actions menu, select **Unpublish**.
