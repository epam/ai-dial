...
| Agents & Toolsets       |    No    | Add [toolsets](#toolsets), [apps](#applications) or [AI models](#models) available to you. **Note**: When using toolsets, make sure to be logged in to use them if authentication is required.                                                                |
...
Toolsets are MCP servers that you can use as tools in [Quick Apps 2.0](#add-quick-app-20) to perform specific actions in your custom workflows.
