...
![Change agent](./img/change-agent.png)
...
![Change agent](./img/change-agent2.png)
...
![Chat settings](./img/chat-settings-new.png)
...
![Chat settings](./img/chat-settings.png)
...
![System_prompt_example_compare_settings](./img/System_prompt_example_compare_settings.png)

![System_prompt_example_conversation](./img/System_prompt_example_conversation.png)
...
![conversation-menu](./img/conv-menu.png)
...
![create-new-folder](./img/create-new-folder.png)
...
![pinned-conversations](./img/pinned-conversations.png)
...
![start conversation](./img/start-conv.png)
...
![rename-conversation](./img/rename-conversation.png)
...
![shared-by-me](./img/shared-by-me.png)
...
![unshare_conv](./img/unshare_conv.png)
...
![duplicate_conv](./img/duplicate_conv.png)
...
![export-with-att](./img/export-with-att.png)
...
![export-without-att](./img/export-without-att.png)
...
![import_conv](./img/import_conv.png)
...
![delete-conversation](./img/delete-conversation.png)
...
![select-chat](./img/select-chat1.png)
...
![select-chat](./img/select-chat2.png)
...
![replay-conversation](./img/replay-conversation.png)
...
![Replay_as_is](./img/Replay_as_is.png)
...
1. Within a conversation, you can set any message as a template for subsequent replay. Use **Set message template** to invoke the **Message template** window.
   ...
   ![param-replay-icon](./img/param-replay-icon.png)
...
2. In the **Message template** window, you can substitute sections of your original message with [variables](#variables) under the **Set template** tab. To achieve this, copy a segment from your original message and paste it into the first input box. Then, in the second input box, introduce a variable using the format: `{{Variable name}}`. For instance, in our example, we have replaced "France" with the `{{Country}}` variable.
   ...
   ![param-replay-form](./img/param-replay-form.png)

   In the **Preview** tab, you can preview your original message with variables:

   ![param-replay-form-preview](./img/param-replay-form-preview.png)
...
![create-new-folder-prompt](./img/create-new-folder-prompt.png)
...
You can also preview system files (names of such files start with the _dot_ e.g. `.abc.txt`) of published application, which are hidden by default, by clicking the **Eye** icon:
...
![Marketplace](./img/dial-marketplace.png)

#### Navigation

You can navigate to this section form the main chat screen:

![Marketplace](./img/dial-marketplace1.png)
...
### DIAL Marketplace Home Page

Click **DIAL Marketplace** to navigate to the _home page_ of DIAL Marketplace. Here, you can find all [applications](#applications) and [language models](#available-models) available on your DIAL environment for your [user role](/docs/platform/3.core/2.access-control-intro.md#roles-as-subjects), including all applications [published](#publish-app) in your organization and [shared](#share-app) with you by other users.
...
![Add to my workspace](./img/add-to-workspace.png)
...
![Marketplace](./img/marketplace-home-select.png)
...
![Add to continue](./img/add-to-continue.png)
...
3. Once the graph is generated, you can view it in the **Content** tab. In this tab, you can view and test the graph, use toolbar to work with nodes.
