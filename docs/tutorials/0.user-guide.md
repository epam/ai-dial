...
* If a public toolset is logged in - it displays the ORG CREDS label on its card. You can use it right away without any additional actions.
* If a public toolset is not logged in - it displays the LOGGED OUT label on its card. Click **Login with my creds** to log in and use the toolset.
