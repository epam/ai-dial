...
> * Refer to [Add Mindmap](#add-mindmap) to learn how to add a mindmap application using a UI wizard.
...
> * Watch a [video demo](/docs/video%20demos/2.Applications/mindmap-studio.md) describing the Mindmap Application Studio.
...
Once you launch the Mindmap Application Builder, on the first screen you will be able to enter general info parameters. This information will be rendered on the application's card in DIAL Marketplace.
...
2. When done, click **Save**. Your mindmap application will appear in [My workspace](#my-workspace). You can now use it, edit, share or publish.
