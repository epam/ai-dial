...
Quick Apps 2.0 is a composer for building applications from reusable components. It gives possibility to put together new applications from DIAL-native tools (apps and AI models) and external integrations (MCP servers), with any AI model registered in DIAL Core acting as the agent orchestrator.
...
In DIAL Marketplace you can find all [applications](#applications) and [language models](#available-models) available on your DIAL environment. Each user can access only those applications and models that are available to their [user role](/docs/platform/3.core/2.access-control-intro.md#roles-as-subjects).
...
Click **DIAL Marketplace** to navigate to the *home page* of DIAL Marketplace. Here, you can find all [applications](#applications) and [language models](#available-models) available on your DIAL environment for your [user role](/docs/platform/3.core/2.access-control-intro.md#roles-as-subjects), including all applications [published](#publish-app) in your organization and [shared](#share-app) with you by other users.
