...
1. In My workspace, click **Add app** and select **Mind Map** to launch the Mind Map Studio.
...
In the **Customize** section, you can access a collection of customization options for the knowledge graph and chatbot. As you experiment with styles, you can preview changes in real time in the Preview screen.
