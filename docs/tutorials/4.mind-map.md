...
Knowledge graphs created with DIAL Mind Map Studio offer a fully deterministic way of information discovery entirely based on the provided sources. The knowledge graph itself and the chat-bot will will avoid providing information that is not a part of the provided sources. 
