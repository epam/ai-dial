...
> Refer to [Example](https://github.com/epam/ai-dial/blob/7c5a6ffef90c6d252b74478571f06554d1be1951/docs/dial-docker-compose/model/core/config.json#L11) to view and example of a configuration JSON file.
