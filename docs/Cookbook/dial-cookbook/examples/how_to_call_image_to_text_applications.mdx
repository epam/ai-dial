...
**[View Jupyter
Notebook](https://github.com/epam/ai-dial/blob/main/dial-cookbook/examples/how_to_call_image_to_text_applications.ipynb)**
...
`langchain-openai<=0.0.2` ignores the additional fields in the request.
