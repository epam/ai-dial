...
**[View Jupyter
Notebook](https://github.com/epam/ai-dial/blob/main/dial-cookbook/examples/how_to_call_text_to_image_applications.ipynb)**
...
`langchain-openai<=0.0.2` ignores the additional fields attached to the
response message.
