...
Environment variables to configure embeddings thread pools DIAL_RAG**CPU_POOLS**INDEXING_EMBEDDINGS_POOL and DIAL_RAG**CPU_POOLS**QUERY_EMBEDDINGS_POOL are no longer used.
