...
**DIAL Chat**
* **Custom Visualizers:** Operators can map a MIME type to their own sandboxed web app for rendering that attachment type.
* **Toolset & Editor Configuration:** A new allowed-tools selector for toolsets, a token-endpoint auth-method selector for toolset OAuth, and a Compact Mode display density toggle.
