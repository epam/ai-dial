...
Follow this tutorial to launch DIAL Chat locally with Echo application. As a result, you will be able to access Chat on [http://localhost:3000](http://localhost:3000) and use Echo application to mirror your prompts.
...
Once DIAL Chat is up on [http://localhost:3000](http://localhost:3000), select the Echo Application in [DIAL Marketplace](/docs/platform/4.chat/1.marketplace.md) and start typing in prompts to see how the Echo application mirrors them.

![Chat](./img/dial-chat-local.png)
