...
> * Need the full stack with Admin and Keycloak instead? See [Launch the Full DIAL Stack](/docs/tutorials/1.developers/0.local-run/2.quick-start-full-stack-advanced.md).
