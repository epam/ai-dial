...
If you encounter a synonym or variant not listed below, use the canonical term instead. See the [concept map](/docs/NEW/understand-dial/foundations/core-concepts-and-glossary/concept-map) for a visual overview of how these terms relate.
...
- [Concept map](/docs/NEW/understand-dial/foundations/core-concepts-and-glossary/concept-map) — see how these terms relate to one another
- [Architecture highlights](/docs/NEW/understand-dial/architecture/architecture-highlights) — how the components fit together at runtime
- [What is DIAL](/docs/NEW/understand-dial/positioning/what-is-dial) — start here if you are new to the platform
