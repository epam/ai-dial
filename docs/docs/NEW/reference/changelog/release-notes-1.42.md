---
# Generated by scripts/build-changelog.ts from docs/releases/1.42/1.42-release-notes.md — do not hand-edit.
title: "DIAL 1.42 release notes"
sidebar_label: "1.42 release notes"
sidebar_position: -2084
type: "reference"
persona: "all"
component: "platform"
description: "The highlights of this release include significant improvements to MCP Toolsets including analytics and mid-chat authentication flow, additional chat UI enhancements for borderless attachments, Hugging Face registry integration, several new…"
---
