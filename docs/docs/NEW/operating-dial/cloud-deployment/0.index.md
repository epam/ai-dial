...
- [DIAL Stack](/docs/NEW/understand-dial/architecture/dial-stack) — the components the charts deploy and how they fit together
- [Core configuration](/docs/NEW/operating-dial/configuration/core/index) — the `config.json` and `settings.json` the charts render
