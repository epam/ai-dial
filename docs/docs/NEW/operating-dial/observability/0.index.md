...
| Adapters and Applications | Traces, metrics (including system CPU and memory), and logs over OTLP | [DIAL SDK telemetry](/docs/NEW/building-with-dial/developer-tools/sdk-reference/telemetry) (Python) |
...
- [DIAL Stack](/docs/NEW/understand-dial/architecture/dial-stack) — the components that emit the telemetry described here
- [SDK telemetry reference](/docs/NEW/building-with-dial/developer-tools/sdk-reference/telemetry) — how applications and adapters built on the DIAL SDK emit OTEL signals
