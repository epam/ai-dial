...
**Note**
> Access to agents is governed by your role. See [Authentication and access control](../understand-dial/security-and-governance/1.authentication-and-access-control.md).
...
**Note**
> See [Supported providers](../building-with-dial/adapters/2.supported-providers.md) for the models supported in DIAL.
...
**Note**
> See the [DIAL Apps overview](../building-with-dial/apps/0.index.md) for in-depth information about applications and application types.
...
**Note**
> See the [Quick Apps overview](../building-with-dial/apps/quick-apps/0.index.md) for configuration and deployment guidance for developers.
...
| Configure toolset | No | Valid JSON with a toolset configuration. See the [Quick Apps overview](../building-with-dial/apps/quick-apps/0.index.md). |
...
**Note**
> See [Custom buttons in apps](../building-with-dial/apps/custom-apps/4.custom-buttons.md) to learn more.
...
**Note**
> Your Mind Map appears only in My workspace. To let others use it, [share or publish](./6.sharing-and-publishing.md) it. For the full authoring workflow, see [Mind Map Studio](../building-with-dial/apps/mind-map-studio/0.index.md).
