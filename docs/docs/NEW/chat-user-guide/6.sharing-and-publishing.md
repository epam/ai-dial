...
2. An administrator reviews it and approves or declines it. The administrator can also modify the request, including access rules. See [Publications and review](../administering-dial/6.publications-and-review.md).
...
**Note**
> Publications must be enabled in your deployment. See [Enable publications](../operating-dial/configuration/1.enable-publications.md).
...
**Note**
> See [Collaboration and sharing](../understand-dial/capabilities/4.collaboration-and-sharing.md) to learn more about collaboration in DIAL.
...
**Note**
> You can share only your own applications. You cannot share an application shared with you unless re-sharing rights were explicitly granted. See [Collaboration and sharing](../understand-dial/capabilities/4.collaboration-and-sharing.md).
...
**Note**
> All publication requests are reviewed by administrators. See [Authentication and access control](../understand-dial/security-and-governance/1.authentication-and-access-control.md) to learn about public resources.
...
**Important**
> The effective access rule for an asset in a subfolder includes restrictions from all parent subfolders up to the root. See [Work with publications](/docs/tutorials/1.developers/1.work-with-resources/0.work-with-publications.md#effective-rules) to learn about effective rules for folders.
...
- [Publications and review](../administering-dial/6.publications-and-review.md) — how administrators review requests
