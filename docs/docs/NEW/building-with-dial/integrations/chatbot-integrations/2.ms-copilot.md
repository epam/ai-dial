...
- [Integration with Microsoft Teams](ms-teams) — bring DIAL into Microsoft Teams through a custom bot
- [Chatbot integrations](index) — all chatbot integration guides

## Next steps

- [Unified API reference](https://dialx.ai/dial_api) — the DIAL API methods your connector calls
- [Integrations overview](../index) — explore other ways to connect DIAL with external systems
