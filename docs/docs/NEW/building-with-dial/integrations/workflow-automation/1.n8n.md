...
:::tip
Watch a [demo video](/docs/video%20demos/3.Developers/Integrations/15.dial-n8n-integration.md) to see an AI-powered HR assistant built with a custom DIAL node and n8n automation before you start.
:::
...
- [Integration with MS Excel](../productivity-add-ins/ms-excel) — call DIAL from spreadsheet formulas
- [Integration with MS Teams](../chatbot-integrations/ms-teams) — bring DIAL into your messaging platform

## Next steps

- [Workflow automation](index) — see other automation integrations
- [Integrations overview](../index) — browse all integration categories
