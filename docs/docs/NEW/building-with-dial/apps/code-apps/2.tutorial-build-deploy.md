...
- [Custom Apps: architecture and lifecycle](../custom-apps/0.index.md) — when your app outgrows Code Apps and needs custom dependencies, external API access, or dedicated infrastructure
- [What are Quick Apps](../quick-apps/0.index.md) — use your Code App as a tool in no-code orchestration workflows
