...
The toolset is private to your account until you [share or publish it](3.sharing-and-permissions.md). To use it in a Quick App 2.0, see [Add tools and agents to a Quick App 2.0](../working-with-tools-and-agents.md).
...
- [Toolsets — `config.json` reference](../../../../../operating-dial/configuration/core/config-json/7.toolsets.md) — all attributes: `endpoint`, `transport`, `authType`, `userRoles`, `allowedTools`, and more
- [Toolsets security — `settings.json` reference](../../../../../operating-dial/configuration/core/settings-json/9.toolsets-security.md) — OAuth redirect URIs, resource settings, and KMS encryption
...
- [Add tools to a Quick App 2.0](../working-with-tools-and-agents.md) — reference Tool Sets from an app
