...
This page contains complete, copy-pasteable Quick App 2.0 configurations for common use cases. Each example is a full `applicationProperties` object suitable for the [DIAL Core API](/docs/NEW/building-with-dial/apps/quick-apps/authoring-guide#create-via-api) or the JSON editor in DIAL Chat.
