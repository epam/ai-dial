...
- **Development studio** — agent builders such as [Quick Apps](/docs/tutorials/0.user-guide.md#application-builder) and Code Apps let users create applications using low-code and no-code wizards directly from Marketplace. Pre-built agents can be used as building blocks in new applications.
...
3. Published applications enter an approval queue visible to administrators in the [DIAL Admin panel](/docs/docs/NEW/operating-dial/configuration/3.chat-configuration.md).
...
- [DIAL Chat configuration](/docs/docs/NEW/operating-dial/configuration/3.chat-configuration.md) — enable or disable Marketplace via feature flags
