...
The [Marketplace](/docs/platform/4.chat/1.marketplace.md) lists ready-to-use applications and agents alongside models.

1. Open the Marketplace.
2. Pick an application — for example, a [Mind Map](/docs/tutorials/4.mind-map.md) or a Quick App.
...
- [What is DIAL](/docs/platform/0.architecture-and-concepts/0.vision.md) — the platform vision and what problems it solves
