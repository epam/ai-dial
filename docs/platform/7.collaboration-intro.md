...
DIAL Chat end users can request publication through [DIAL Chat UI](/docs/tutorials/0.user-guide.md#publications). DIAL Core also offers [Publication API](https://dialx.ai/dial_api#tag/Publications) to create and manage publications programmatically. All publication requests require administrator approval to ensure security and safety. [Administrators](/docs/platform/11.admin-panel.md) have access to the Public folder and can modify resources within it.
...
DIAL Chat end users can create a sharing link via [DIAL Chat UI](/docs/tutorials/0.user-guide.md#share-2). DIAL Core offers [Sharing API](https://dialx.ai/dial_api#tag/Sharing) to share resources programmatically. 
