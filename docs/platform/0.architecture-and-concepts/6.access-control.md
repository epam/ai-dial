...
Objects in DIAL can belong to either _Private_ or _Public_ logical space.
...
- Can command DIAL Core to reload _"dynamic settings"_ configuration files without restarting DIAL Core services.
