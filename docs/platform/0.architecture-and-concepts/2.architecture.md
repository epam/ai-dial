...
**Standard application builders**: 

DIAL includes pre-built application builders for:
...
Organizations can develop **custom application builders** using the DIAL SDK to create domain-specific application templates tailored to their use cases.
