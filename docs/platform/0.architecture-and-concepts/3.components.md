...
> * Refer to [Cost Control](/docs/platform/3.core/8.token-limits-and-cost-control.md) to learn more about cost management in DIAL.
...
* [Adapter](#model-adapters): Adapters unify APIs of respective LLMs to align with the Unified Protocol of DIAL Core. Refer to [AI Model Providers](/docs/platform/2.supported-models.md) to view all the supported model adapters and language models.
...
> Refer to [Access Control Introduction](/docs/platform/0.architecture-and-concepts/6.access-control.md#roles) to learn about roles-based access to resources.
