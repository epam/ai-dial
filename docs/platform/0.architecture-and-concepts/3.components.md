...
> Refer to [Auth](/docs/platform/3.core/1.auth-intro.md) to learn how to authenticate API keys and chat users and to [Roles & Access Control](/docs/platform/3.core/2.access-control-intro.md) to learn how to implement a custom role-based access policy.
...
> * Refer to [AI DIAL Configuration](/docs/tutorials/2.devops/1.configuration/0.configuration-guide.md#dynamic-settings) to learn more about roles and rate limits.
> * Refer to [Roles & Access Control](/docs/platform/3.core/2.access-control-intro.md) to learn how to configure limits for API keys and users.
...
**Application**: any custom logic with a conversation interface packaged as a ready-to-use solution. It can be any component conforming with Unified Protocol requirements. Refer to [Applications](/docs/tutorials/0.user-guide.md#applications) to learn more about DIAL apps and their types.
...
> Refer to [Observability](/docs/tutorials/2.devops/3.observability-config.md) to learn more.
...
> Refer to [Authentication](docs/platform/3.core/1.auth-intro.md) to learn about supported identity service providers.
