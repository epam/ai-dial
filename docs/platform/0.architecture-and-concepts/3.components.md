...
> * Refer to [DIAL Stack](/docs/platform/0.architecture-and-concepts/6.stack.md) to see the technological stack and minimal resources that are required to operate the platform.
