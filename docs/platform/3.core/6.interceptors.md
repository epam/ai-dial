...
3. Provide this JSON schema as the value for the `"applicationTypeSchemas"` parameter in [DIAL Core dynamic settings](https://github.com/epam/ai-dial-core?tab=readme-ov-file#dynamic-settings).
