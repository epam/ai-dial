    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                { type: 'doc', id: 'docs/NEW/operating-dial/production-readiness/index', label: 'Overview' },
                { type: 'doc', id: 'docs/NEW/operating-dial/production-readiness/high-availability', label: 'High availability' },
                { type: 'doc', id: 'docs/NEW/operating-dial/production-readiness/scaling', label: 'Scaling' },
                { type: 'doc', id: 'docs/NEW/operating-dial/production-readiness/secrets-management', label: 'Secrets management' },
                { type: 'doc', id: 'docs/NEW/operating-dial/production-readiness/backup-and-restore', label: 'Backup and restore' },
                { type: 'doc', id: 'docs/NEW/operating-dial/production-readiness/upgrade-procedure', label: 'Upgrade procedure' },
                { type: 'doc', id: 'docs/NEW/operating-dial/production-readiness/cost-control', label: 'Cost control' },
        ...
        },
        {
          type: 'category',
          label: 'Reference',
          link: { type: 'doc', id: 'docs/NEW/reference/index' },
          items: [
            { type: 'doc', id: 'docs/NEW/reference/unified-api', label: 'Unified API' },
            { type: 'ref', id: 'docs/NEW/building-with-dial/developer-tools/sdk-reference/index', label: 'SDK reference' },
            { type: 'ref', id: 'docs/NEW/operating-dial/configuration/index', label: 'Configuration reference' },
            { type: 'ref', id: 'docs/NEW/understand-dial/foundations/core-concepts-and-glossary/glossary', label: 'Glossary' },
            { type: 'ref', id: 'docs/NEW/building-with-dial/adapters/supported-providers', label: 'Supported models and providers' },
            {
              type: 'category',
              label: 'Changelog',
              items: [
                { type: 'autogenerated', dirName: 'docs/NEW/reference/changelog' },
              ],
            },
            { type: 'doc', id: 'docs/NEW/reference/compatibility-matrix', label: 'Component compatibility matrix' },
          ],
        },
        {
          type: 'category',
          label: 'Use Cases',
          link: { type: 'doc', id: 'docs/NEW/use-cases/index' },
          items: [
            { type: 'doc', id: 'docs/NEW/use-cases/org-wide-ai-assistant', label: 'Org-wide AI assistant' },
            { type: 'doc', id: 'docs/NEW/use-cases/chat-with-your-knowledge-base', label: 'Chat with your knowledge base' },
            { type: 'doc', id: 'docs/NEW/use-cases/no-code-ai-tools', label: 'No-code AI tools for business teams' },
            { type: 'doc', id: 'docs/NEW/use-cases/one-api-every-provider', label: 'One API for every model provider' },
            { type: 'doc', id: 'docs/NEW/use-cases/cost-and-usage-governance', label: 'Centralized cost and usage governance' },
            { type: 'doc', id: 'docs/NEW/use-cases/custom-production-agents', label: 'Custom production AI agents' },
            { type: 'doc', id: 'docs/NEW/use-cases/embed-ai-in-existing-tools', label: 'Embed AI in existing tools' },
            { type: 'doc', id: 'docs/NEW/use-cases/measure-and-improve-quality', label: 'Measure and improve AI quality' },
            { type: 'doc', id: 'docs/NEW/use-cases/compliance-and-pii-safe-ai', label: 'Compliance and PII-safe AI' },
          ],
        },
        {
          type: 'category',
          label: 'Demos',
          link: { type: 'doc', id: 'docs/NEW/demos/index' },
          items: [
            { type: 'doc', id: 'docs/NEW/demos/platform-overview', label: 'Platform overview' },
            { type: 'doc', id: 'docs/NEW/demos/chat-capabilities', label: 'Chat capabilities' },
            { type: 'doc', id: 'docs/NEW/demos/apps-and-agents', label: 'Apps and agents showcase' },
            { type: 'doc', id: 'docs/NEW/demos/deployment-and-admin', label: 'Deployment and admin walkthrough' },
            { type: 'doc', id: 'docs/NEW/demos/developer-features', label: 'Developer features' },
            { type: 'doc', id: 'docs/NEW/demos/integrations', label: 'Integrations' },
          ],
        },
      ],
    },
