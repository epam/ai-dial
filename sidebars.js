          ...
          items: [
            {
              ...
              items: [
                ...
                {
                  type: 'doc',
                  id: 'docs/NEW/operating-dial/configuration/configuration-files',
                  label: 'Configuration Files',
                },
                {
                  type: 'doc',
                  id: 'docs/NEW/operating-dial/configuration/core-configuration',
                  label: 'DIAL Core Configuration',
                },
                {
                  type: 'doc',
                  id: 'docs/NEW/operating-dial/configuration/chat-configuration',
                  label: 'DIAL Chat Configuration',
                },
                {
                  type: 'doc',
                ...
                },
                {
                  ...
                  label: 'Auth Helper Configuration',
                },
                {
                  type: 'doc',
                ...
                {
                  type: 'doc',
                  id: 'docs/NEW/operating-dial/configuration/supporting-services',
